...
(function ($, window, document, undefined) {
        ...
        altEditor.prototype,
        {
            ...
            _constructor: function () {
                ...
                if (dt.settings()[0].oInit.onEditRow)
                    that.onPreEditRow = dt.settings()[0].oInit.onEditRow;
				else
					that.onPreEditRow = null;
            ...
            _openEditModal: function () {
                ...
                for (var j in columnDefs) {
                    ...
                    if (columnDefs[j].type.indexOf("hidden") >= 0) {
                        ...
                        data += "<div class='col-sm-3 col-md-3 col-lg-3 text-left' style='padding-top:4px;'>"
						...
						if (columnDefs[j].type.indexOf("textarea") >= 0) {
                            data += "<textarea rows='5' id='"
                                ...
                                + " style='overflow:hidden' class='form-control  form-control-sm'>"
                                + that._quoteattr(adata.data()[0][columnDefs[j].name]) + "</textarea>";
            ...
            _openAddModal: function () {
                ...
                for (var j in columnDefs) {
                    if (columnDefs[j].type.indexOf("hidden") >= 0) {
                        ...
                        data += "<div style='margin-left: initial;margin-right: initial;' class='form-group row'><div class='col-sm-3 col-md-3 col-lg-3 text-left' style='padding-top:4px;'><label for='"
                            + columnDefs[j].title
                            + "'>"
                            + columnDefs[j].title
			...
			onPreEditRow : function(dt, rowdata, success, error) { alert("this should never be called!"); },
    ...
    $(document).on('preInit.dt.altEditor', function (e, settings, json) {
        ...
        if (init || defaults) {
			...
			var test = new DataTable.Api(settings);
			console.log(test);
